...
public class CategoriaResource {
	...
	// a anotação abaixo serve para injetar essa dependência, no momento da injeção
	// ele da um new em categoriaRepository
	 ...
	 * 
	 * @GetMapping("/outro") public String outro() { return "ok"; }
	 */
